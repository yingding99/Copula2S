# Copula2S contains the key R functions for implementing the two-parameter copula-based sieve semiparametric transformation model for bivariate interval-censored data. 
